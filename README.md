...
### Задание 00 — Roles and their activities as is (Роли и их действия as is) 
**Для каждой задачи:** 
...
### Задание 01 — Creating a context diagram (Создание контекстной диаграммы)
**Для задачи 2:**
...
### Задание 02 — Solving the problems of stakeholders (Разрешение проблем стейкхолдеров) 
**Для каждой задачи:**
...
### Задание 03 — Сheck of input and output streams (Проверка входных/выходных потоков данных) 
**Для каждой задачи:**
...
### Задание 04 — Adding artifacts (Дополнение артефактов) <div id="55"></div>
**Для каждой задачи:**
